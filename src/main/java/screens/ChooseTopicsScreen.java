...
public class ChooseTopicsScreen extends ScreenBase {
	...
	public WebElement primaryContinueButton;
	
	@AndroidFindBy(id="flipboard.app:id/edu_full_screen_sheet_action_primary")
	public WebElement primaryContinueButton2;
    ...
    public ChooseTopicsScreen clickPrimaryContinue()
    {
    	primaryContinueButton.click();
    	
    	return this;
    }
    public ChooseTopicsScreen clickPrimaryContinueBtn()
    {
    	primaryContinueButton2.click();
